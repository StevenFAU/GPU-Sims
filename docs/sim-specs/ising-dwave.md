# Ising Model on D-Wave — Specification

> **Status:** Specification pending — not yet drafted by the architect chat
> **Category:** Quantum
> **Primary stack:** D-Wave Leap
> **Secondary stack(s):** B (WebGPU visualization)
> **Target machine:** Scheduled D-Wave time, anywhere for viz
> **Folder:** [`quantum/ising-dwave`](../../quantum/ising-dwave/)
