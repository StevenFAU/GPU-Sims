# Neural CA — Specification

> **Status:** Specification pending — not yet drafted by the architect chat
> **Category:** Continuous CA
> **Primary stack:** D (Python / PyTorch)
> **Secondary stack(s):** B (WebGPU deploy)
> **Target machine:** Lab PC training, anywhere for deploy
> **Folder:** [`continuous-ca/neural-ca`](../../continuous-ca/neural-ca/)
