...
- **Point-emitter / sparse-source pattern.** Consumers: physarum food pins (#1), boids-3d leader attractors (#2). Promotion review scheduled at consumer #3 (likely eulerian-smoke / sph-water / lattice-boltzmann emitters). Boids-3d's predators are a different shape entirely (auto-spawned, no user placement), don't count as #3 of this pattern.
