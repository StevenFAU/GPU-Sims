...
- License: MIT
- Latest commit: ``50b8c2d`` — Phase 9 (common-py + mpm-multimaterial; first Stack D infrastructure + first Stack D sim, on top of ``35bc0fa``, Phase 8.5.2 markdownlint cleanup).
- Live sims:
