...
256³ Stam stable fluids with vorticity confinement, single-scattering ray march, moving obstacles.
...
Canonical papers and reference implementations are tracked in the [spec sheet](../../docs/sim-specs/eulerian-smoke.md).
